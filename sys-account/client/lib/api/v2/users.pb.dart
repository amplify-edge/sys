...
class UserDefinedFields extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UserDefinedFields', package: const $pb.PackageName('getcouragenow.sys.v2.sys_account'), createEmptyInstance: create)
    ..m<$core.String, $3.Any>(1, 'fields', entryClassName: 'UserDefinedFields.FieldsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $3.Any.create, packageName: const $pb.PackageName('getcouragenow.sys.v2.sys_account'))
